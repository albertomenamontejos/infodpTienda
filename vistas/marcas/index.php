...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">                        
				<h2 class="hstyle">Marcas</h2>
				<a href="<?php url("marcas/crear") ?>" class="btn btn-redTienda"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nueva</a>
			</div>
		</div>	
		<hr>
		<div class="row">
			<div class="col-lg-12">                        
				...
				<table id="vistaMarcas" class="table-striped table-hover table-condensed" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>Id</th>
							<th>Descripción</th>
...
<script>
	...
	//Control de stock con JQuery
   	$('#vistaMarcas').DataTable({	
		...
		"pageLength": 10,
		dom: 'Bfrtilp',
        "sAjaxSource": "libreria/ServerSide/serversideMarcas.php",		
		"columnDefs": [ {
            "targets": -1,
            "data": null,
	...
	$(document).on("click", ".btnEditar", function(){		
		...
		window.location.href="marcas/editar?id="+id;	
	 });
	$(document).on("click", ".btnEliminar", function(){		
		var id = parseInt($(this).closest('tr').find('td:eq(0)').text()) ; //capturo la cantidad		
		alertify.confirm('Eliminar Registro','¿Está seguro de eliminar el registro?',
		function(){window.location.href=window.location.href="marcas/eliminar?id="+id;},
