		...
		<div class="row">
			...
			<div class="panel panel-azulTienda">
				  <div class="panel-heading">
						...
						<form action="<?php url("marcas/crearmarca") ?>" method="POST" role="form">
						<?php if (isset($marca)) {?>
						<input type="hidden" value="<?php echo htmlspecialchars($marca->id)  ?>" name="id">
						<?php }?>		
				  <div class="panel-body">
					<div class="form-group">
						<label for="">Descripción</label>
						<input name="txtDescripcion" type="text" pattern="[A-Z a-zñÑáéíóúÁÉÍÓÚ0-9_-]{1,30}" class="form-control" id="txtDescripcion" placeholder="Nombre de la Marca" value="<?php echo isset($marca) ?htmlspecialchars($marca->descripcion)  : '' ?>" tabindex="1" required autofocus>    
					</div>   
				  </div>
