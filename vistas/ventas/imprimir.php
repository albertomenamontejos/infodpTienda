...
<!--	</div>-->
	...
	<div id="nombreComprobante"><?php echo $comprobante->descripcion ?></div>s
	<div id="factSupDer">
	...
	<table id="tablaDetalle" class="table">
		<thead>	
			...
			<th>% Bonif</th>
			<th>Subtotal</th>
			<th>Alic. <?php echo $detalleimpositivoventa->nom_imp ?></th>
			<th>Subtotal c/<?php echo $detalleimpositivoventa->nom_imp ?></th>
			</tr>			
		</thead>
		<tbody>
			<?php   
			...
			<tr>
				...
				<td><?php echo trim($detalleventa->nomProd); ?></td>
	...
	<table id="tablaTotales" class="table">	
		<tbody>
			<tr>
				<td>Importe Neto: <?php echo $detalleimpositivoventa->moneda?></td>
				<td><?php echo sprintf('%0.2f',$venta->subTotalNeto); ?></td>
			</tr>			
			<tr>
				<td><?php echo $detalleimpositivoventa->nom_imp ?> <?php echo $detalleimpositivoventa->porc_imp ?>: <?php echo $detalleimpositivoventa->moneda?></td>
