			...
			<div class="col-lg-12">
				<div class="panel panel-azulTienda">
					  <div class="panel-heading">
							<h3 class="panel-title">Editar Tarjeta</h3>
					  </div>
						 <form action="<?php url("tarjetas/editartarjeta") ?>" method="POST" role="form">
					  <div class="panel-body">            
						<input type="hidden" value="<?php echo $tarjeta->id ?>" name="id">
						<div class="form-group">
							<label for="">Descripción</label>
							<input value="<?php echo $tarjeta->descripcion ?>" name="txtDescripcion" type="text" class="form-control" id="" placeholder="" tabindex="1" required autofocus>    
						</div>
					  </div>
