...
<head>
    ...
    <script src="<?php asset("bower_components/highcharts/js/highcharts.js")?>"></script>
    <script src="<?php asset("bower_components/highcharts/js/modules/exporting.js")?>"></script>
	<script src="<?php asset("bower_components/highcharts/js/highcharts-more.js")?>"></script>
	<script src="<?php asset("bower_components/highcharts/js/highcharts-3d.js")?>"></script>
	<script src="<?php asset("bower_components/highcharts/js/modules/data.js")?>"></script>
	...
	<!--Código JS Reportes Gráficos unificado-->
    <script src="<?php asset("bower_components/js/codigo_reportes_graficos.js")?>"></script>			
