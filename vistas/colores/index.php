	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">                        
				...
				<a href="<?php url("colores/crear") ?>" class="btn btn-redTienda"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nuevo</a>
			</div>			
		</div>	
		<hr>		
		<div class="row">														
...
<script>
	...
	//Control de stock con JQuery
   	$('#vistaTalles').DataTable({	
		...
		"pageLength": 10,
		dom: 'Bfrtilp',
        "sAjaxSource": "libreria/ServerSide/serversideColores.php",		
		"columnDefs": [ {
            "targets": -1,
            "data": null,
	...
	$(document).on("click", ".btnEditar", function(){		
		...
		window.location.href="colores/editar?id="+id;	
	 });
	$(document).on("click", ".btnEliminar", function(){		
		var id = parseInt($(this).closest('tr').find('td:eq(0)').text());
		alertify.confirm('Eliminar Registro','¿Está seguro de eliminar el registro?',
		function(){window.location.href=window.location.href="colores/eliminar?id="+id;},
